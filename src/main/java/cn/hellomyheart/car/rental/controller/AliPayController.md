 ...
 * @package: cn.hellomyheart.car.rental.controller
 * @author: Stephen Shen
 * @date: 2020/9/22 上午8:06
 */
@Controller
public class AliPayController {
    private final String APP_ID = "2021000116684205";
    private final String APP_PRIVATE_KEY = "XXX";
    private final String CHARSET = "UTF-8";
    private final String ALIPAY_PUBLIC_KEY = "XXX";
    ...
    private final String RETURN_URL = "http://127.0.0.1:8080/alipay.trade.page.pay-JAVA-UTF-8/return_url.jsp";
